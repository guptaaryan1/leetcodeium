class Twitter:
    ...
    def follow(self, followerId: int, followeeId: int) -> None:
        if followerId == followeeId:
            return
        if (followerId not in self.users) and (followeeId not in self.users):
            self.users[followerId] = [[], [], []]
            self.users[followeeId] = [[], [], []]
        elif (followerId not in self.users) and (followeeId in self.users):
            self.users[followerId] = [[], [], []]
        elif (followeeId not in self.users) and (followerId in self.users):
            self.users[followeeId] = [[],[],[]]
